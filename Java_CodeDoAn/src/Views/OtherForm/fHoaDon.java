...
import Models.Xe;
import Report.Fields_Report_HoaDon;
import Report.Parameter_Report_HoaDon;
import Report.ReportManager_HoaDon;
...
public class fHoaDon extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnInHoaDon = new Views.OtherForm.swing.MyButton();
        ...
        btnInHoaDon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Views/OtherForm/Icon/printer.png"))); // NOI18N
        btnInHoaDon.setText("IN");
        btnInHoaDon.setToolTipText("");
        btnInHoaDon.setBorderColor(new java.awt.Color(51, 102, 255));
        btnInHoaDon.setRadius(20);
    ...
    private void btnInHoaDonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInHoaDonActionPerformed
        if (tfMaHoaDon.getText().equals("")){
            MessageAlerts.getInstance().showMessage("Cảnh báo!", "Vui lòng chọn hóa đơn để in!",
                        MessageAlerts.MessageType.WARNING);
            return;
        }
        String maHD = tfMaHoaDon.getText();
        String ngayLapHD = tfNgayLapHoaDon.getText();
        ...
        //Parameter Report
        Parameter_Report_HoaDon dataPrint = new Parameter_Report_HoaDon();
        dataPrint.setMaHoaDon(maHD);
        dataPrint.setNgayLapHoaDon(ngayLapHD);
        dataPrint.setTenNhanVienThucHien(nv.getHoTenNhanVien());
        dataPrint.setHoTenKhachHang(kh.getHoTenKhachHang());
        ...
        try {
            ...
            ReportManager_HoaDon.getInstance().printReportPayment(dataPrint);
        } catch (JRException e) {
            e.printStackTrace();
        }
    ...
    private void cbbMaXeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbbMaXeActionPerformed
        // Tự động load giá bán cho mỗi mã xe ô tô
        long giaBan = XeDAO.getInstance().getGiaBan(cbbMaXe.getSelectedItem().toString());
        tfTongTien.setText(String.valueOf((long)((long)giaBan * 1.1 + 20000000)));
    ...
    private Views.OtherForm.swing.MyButton btnInHoaDon;
